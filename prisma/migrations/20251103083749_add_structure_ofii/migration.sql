...
ADD CONSTRAINT "StructureOfii_operateurId_fkey" FOREIGN KEY ("operateurId") REFERENCES "public"."Operateur"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "public"."StructureOfii"
ADD CONSTRAINT "StructureOfii_departementNumero_fkey" FOREIGN KEY ("departementNumero") REFERENCES "public"."Departement"("numero") ON DELETE
SET NULL ON UPDATE CASCADE;