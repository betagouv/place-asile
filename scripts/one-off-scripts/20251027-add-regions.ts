...
export async function addRegions() {
    ...
    for (const department of DEPARTMENTS) {
        await prisma.departement.upsert({
            where: { numero: department.num_dep },
            update: { name: department.dep_name, region: department.region_name },
            create: { numero: department.num_dep, name: department.dep_name, region: department.region_name },
        });
    }
