        ...
        <>
          ...
          <fieldset className="flex flex-col gap-6">
            ...
            <p className="mb-0 w-3/5">
              ...
              provisions et fonds dédiés du CPOM. Pour rendre une année
              éditable, il faut que le montant saisi dans la colonne
              “affectation réserves et fonds dédiés” du tableau précédent soit
              supérieur à 0 pour cette année-là.
            </p>
